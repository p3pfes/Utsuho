        ...
        switch (args[0]) {
            ...
            case "item":
                message.channel.send({
                    embeds: [{
                        color: 0xeb0707,
                        title: 'Utsuho Item Commands',
                        description: "**\nth!items give [character id] [item name]** \n**th!items remove [character id]**. \nYou can view your inventory using **th!inv** or **th!inventory**, and buy items using **th!shop**."
                    }]
                })
                return
            default:
                message.channel.send({
                    embeds: [{
                        ...
                        description: `**\nth!help info \nth!help touhou\nth!help trade \nth!help misc \nth!help item**`,
                        footer: {
                            text: 'Example: If you need help with trade commands, you do `th!help trade`'
                        }
                    }]
