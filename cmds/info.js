...
module.exports = {
    ...
    execute(message,args,client){
        ...
        if(args[0] || message.content.split(' ')[0].toLowerCase() == `${pokeutil.prefix.prefix()}il` || message.content.split(' ')[0].toLowerCase() == 'th!ir'){
            if(message.content.split(' ')[0].toLowerCase() == `ut!il` || message.content.split(' ')[0].toLowerCase() == 'th!ir' || args[0].toLowerCase() == 'recent'|| args[0].toLowerCase() == 'latest'|| args[0].toLowerCase() == 'r'|| args[0].toLowerCase() == 'l'){
        ...
        const exampleEmbed = {
            ...
            footer: {
                text: `Selected Pokémon: ${selected}/${plrdat.poke.length}`,
            },
        };
